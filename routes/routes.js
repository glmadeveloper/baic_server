...
import sendEmail from '../controllers/joinUs/sendEmail.js';
//Job 
import createJob from '../controllers/jobs/create.js';
import getOneJob from '../controllers/jobs/getOne.js';
import getAllJob from '../controllers/jobs/getAll.js';
import updateJob from '../controllers/jobs/update.js';
import deleteJob from '../controllers/jobs/delete.js';
// Job Categories
import createJobCategories from '../controllers/jobsCategories/create.js';
import getOneJobCategories from '../controllers/jobsCategories/getOne.js';
import getAllJobCategories from '../controllers/jobsCategories/getAll.js';
import updateJobCategories from '../controllers/jobsCategories/update.js';
import deleteJobCategories from '../controllers/jobsCategories/delete.js';
...
import getAllUser from '../controllers/user/getAll.js';
import bookServiceMail from '../controllers/service/bookServiceMail.js';
import feedbackMail from '../controllers/service/feedbackMail.js';
import salesMail from '../controllers/service/salesMail.js';
...
router.post("/model",   multer1.uploadImg.any(), createModel);
...
// router.post("/model-category",  createModelCategory);
...
// JOIN US ROUTES =========>
router.post("/join-us", createJoinUs);
router.get("/join-us/:id", getOneJoinUs);
router.get("/join-us", getAllJoinUs);
router.put("/join-us/:id", verifyToken, updateJoinUs);
router.delete("/join-us/:id", verifyToken, deleteJoinUs);
...
// JOB CATEGORY ROUTES =========>
router.post('/job-categories', verifyToken, createJobCategories);
router.get('/job-categories/:id', getOneJobCategories);
router.get('/job-categories', getAllJobCategories);
router.put('/job-categories/:id', verifyToken, updateJobCategories);
router.delete('/job-categories/:id', verifyToken, deleteJobCategories);
...
// ROUTES FOR EMAILS OF SERVICE PAGE

router.post('/book-service-mail', bookServiceMail);
router.post('/feedback-mail', feedbackMail);
router.post('/sales-mail', salesMail);
